...
#pragma endregion
	private: System::Void Form1_Paint(System::Object^  sender, System::Windows::Forms::PaintEventArgs^  e) {
				 ...
				 mat3D V, U, R, T1;
				 mat F;
				 System::Collections::Generic::List<polygon3D^> ^bsplist = gcnew System::Collections::Generic::List<polygon3D^>(0);
				 ...
				 for (int i = 0; i < polygons.Count; i++) {
					 ...
					 if(useFill) {
						 polygon3D^ bspp = gcnew polygon3D(0);
						 for(int j = 0; j < p->Count; j++) {
							 point2vec(p[j], B1);
							 timesMatVec(T1, B1, B2);
							 vec2point(B2, A);
							 bspp->Add(A);
						 }				
						 bsplist->Add(bspp);
				 ...
				 if (useFill) Painter(bsplist, colors, F, U, min, max, image1);
				 g = e->Graphics;
	...
	private: System::Void Form1_KeyDown(System::Object^  sender, System::Windows::Forms::KeyEventArgs^  e) {
				 ...
				 switch(e->KeyCode) {
					...
					case Keys::F: useFill = !useFill; break;
